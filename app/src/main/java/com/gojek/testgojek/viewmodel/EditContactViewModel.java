...
public class EditContactViewModel extends BaseObservable {
    ...
    public EditContactViewModel(Context context, long contactId, Contact contact) {
        this.contact = contact;
        this.context = context;
        this.idContact = contactId;
    }
    ...
    public void onClickSave() {
        ...
        if (validationResponse.equals("Success"))
            setContactDetails(idContact,userContact);
        else
            Toast.makeText(context, validationResponse, Toast.LENGTH_SHORT).show();
    }


    private void setContactDetails(long contactId, Contact user) {
        ...
        Call<Contact> setContactCall = contactsService.putContactsList(contactId,user);
